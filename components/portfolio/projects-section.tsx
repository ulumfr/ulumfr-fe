...
export default function ProjectsSection({ projects = [] }: ProjectsSectionProps) {
    // Show only featured first, then up to 3 total
            ...
            <div className="max-w-6xl mx-auto px-6">
                ...
                {projects.length === 0 ? (
                    ...
                    >
                        ...
                        <p className="text-lg text-muted-foreground mb-1">Projects coming soon</p>
                        <p className="text-sm text-muted-foreground/60 mb-4">Currently cooking something amazing 🚀</p>
                        <Link
                            href="/projects"
                                    ...
                                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-3">
                                        {project.demo_url && (
                                            <a
                                                ...
                                                className="p-2.5 rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-primary/30 hover:border-primary/40 transition-all cursor-pointer"
                                            >
                                    ...
                                    {project.tags && project.tags.length > 0 && (
                                        <div className="flex flex-wrap gap-1.5">
                                            {project.tags.slice(0, 4).map((tag) => (
                                                <span
                                                    key={tag.id}
                                                    className="text-[11px] px-2 py-0.5 rounded-md bg-background/50 border border-white/5 text-muted-foreground font-mono"
                                                >
                                                    {tag.name}
                                                </span>
                                            ))}
